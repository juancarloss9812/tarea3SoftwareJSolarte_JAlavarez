package co.unicauca.tallerSoftware2.cliente;

import co.unicauca.tallerpolimorfismo.logica.*;
...
public class T_3_sw2_jSolarte_jAlvarez {
...
SimpleDateFormat("dd/MM/yyyy").parse("12/07/2019"));
 ...
 Logger.getLogger(T_3_sw2_jSolarte_jAlvarez.class.getName()).log(Level.SEVERE, null,
ex);
 }
 }
 /**
 ...
 */
 ...
 // ya que al ser este método abstracto en la clase padre, les forzamos alas clases hijas a que
